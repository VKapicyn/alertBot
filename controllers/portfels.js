...
'Бот подключен к акциям Московской биржи, а также к основным биржам США.\n'+
'Залить в бота можно свои длинные и короткие позиции по акциям. Чтобы указать короткую позицию, необходимо ввести колличество своих акций со знаком минус.\n'+
'По умолчанию бот отправляет все новости по выбранному портфелю и выполняет функцию новостного агрегатора. Отключить можно в разделе  ":newspaper: Новости"   :arrow_right:   "Новости по компаниям".\n'+
'Состояние портфеля по умолчанию бот отправляет дважды в день. Изменить либо отключить можно в  ":school_satchel:Мои портфели"   :arrow_right:   "Оповещения"\n'+
'В разделе  ":chart_with_upwards_trend: Котировки", вводя тикер акции, бот отправит график и текущую цену без задержки.\n'+
'В разделе  ":alarm_clock: Оповещения" можно выбрать любую акцию и указать необходимую цену. При достижении указанной цены бот оповестит Вас.\n\n'+
':envelope_with_arrow:  При возникновении иных вопросов и предложений: @VKapicyn, @MrGrigoryan'
