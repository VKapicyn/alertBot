...
'По умолчанию бот отправляет все новости по выбранному портфелю и выполняет функцию новостного агрегатора. Отключить можно в разделе "📰 Новости" ↪ "Новости по компаниям".\n'+
'Состояние портфеля по умолчанию бот отправляет дважды в день. Изменить либо отключить можно в "🎒 Мои портфели" ↪ "Оповещения"\n'+
'В разделе "📈 Котировки", вводя тикер акции, бот отправит график и текущую цену без задержки.\n'+
'В разделе "⏰ Оповещения" можно выбрать любую акцию и указать необходимую цену. При достижении указанной цены бот оповестит Вас.\n\n'+
